  ...
  return docInfo && (
    <div>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex-1 border border-gray-400 rounded-lg px-10 py-8 bg-white mx-2 sm:mx-0 -mt-20 sm:mt-0">
          ...
          <div className="">
            ...
            <p className='text-sm text-gray-500 max-w-150 mt-1'>{docInfo.about}</p>
          </div>
